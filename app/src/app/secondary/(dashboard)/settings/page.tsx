        ...
        <div className="flex flex-row justify-between p-4">
          <div className="flex flex-col">
            ...
            <p className="text-sm text-gray-600">
              Choose the model to use for processing
            </p>
          </div>
          <Select
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col items-start">
                        ...
                        <span className="text-xs text-muted-foreground text-left">
                          Ultimate privacy. Runs on your device. No internet
                          required.
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col items-start">
                        <div className="flex items-center gap-2">
                          ...
                          <Badge
                            variant="default"
                            className="text-xs bg-gradient-to-r from-purple-500 to-pink-500 border-none"
                          >
                            Premium
                          </Badge>
                        </div>
      ...
      <div className="outline outline-gray-300 w-full rounded-md mb-6">
        <div className="flex flex-row justify-between p-4">
          <div className="flex flex-col">
            ...
            <p className="text-sm text-gray-600">
              Choose the size of the chat display window
            </p>
          </div>
          <Select
            value={hudSize}
