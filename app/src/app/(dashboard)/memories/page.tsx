...
export default function MemoriesPage() {
    ...
    const loadPage = useCallback(async () => {
        ...
        try {
            ...
            const page = (result || []) as MemoryListItem[];
    ...
    const onDeleteOne = useCallback(async (id: string) => {
        try {
            ...
            setError(typeof e === "string" ? e : e?.message ?? "Failed to delete memory");
        }
    }, []);
                                        ...
                                        <div className="flex flex-row justify-between items-center gap-4 w-full">
                                            ...
                                            <Dialog>
                                                <DialogTrigger asChild>
                                                    <Button variant="ghost" size="icon" aria-label="Delete memory" className="shrink-0">
                                                        ...
                                                        <DialogDescription>
                                                            This action cannot be undone.
                                                                                ...
                                                                                <DialogFooter>
                                                                                    ...
                                                                                    <DialogClose asChild>
                                                                                        <Button variant="destructive" onClick={() => onDeleteOne(m.id)}>Delete</Button>
                                                                                    </DialogClose>
                                                                                </DialogFooter>
                                                </DialogContent>
                                            </Dialog>
                                        ...
                                        <AccordionContent>
                                            <div className="flex flex-col gap-2 text-sm">
                                                <div>
                                                    ...
                                                    <div className="whitespace-pre-wrap break-words">{m.message_content}</div>
                                                </div>
                                                <div>
                                                    <div className="text-xs text-muted-foreground">Saved Memory</div>
                                                    <div className="whitespace-pre-wrap break-words">{m.text}</div>
                                                </div>
                                                <div>
                                                    <div className="text-xs text-muted-foreground">Saved On</div>
                                                    <div className="whitespace-pre-wrap break-words">{new Date(m.timestamp).toLocaleString()}</div>
                                                </div>
                                            </div>
                                        </AccordionContent>
                                    </AccordionItem>
                                    ...
                                    <DialogDescription>
                                        This will permanently remove all memories and their indexes.
                                                ...
                                                <DialogFooter>
                                                    ...
                                                    <DialogClose asChild>
                                                        <Button variant="destructive" onClick={onDeleteAll}>Delete all</Button>
                                                    </DialogClose>
                                                </DialogFooter>
                            </DialogContent>
                        </Dialog>
