...
import { getTaskStatus, getTaskStatusBadgeColor, getTaskStatusText } from "@/lib/task-utils";
...
export function TaskStatusBadge({ taskWithSteps, className }: TaskStatusBadgeProps) {
