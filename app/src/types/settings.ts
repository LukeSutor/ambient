...
export type HudDimensions = { default_width: number, default_height: number, chat_width: number, input_bar_height: number, chat_max_height: number, login_width: number, login_height: number, };
