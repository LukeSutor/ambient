...
pub fn run() {
  ...
  tauri::Builder::default()
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      auth::auth_commands::logout,
      auth::auth_commands::is_authenticated,
      auth::auth_commands::sign_up,
      auth::auth_commands::sign_in,
      auth::auth_commands::verify_otp,
      auth::auth_commands::resend_confirmation,
      auth::auth_commands::refresh_token,
      auth::auth_commands::get_auth_state,
