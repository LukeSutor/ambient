...
#[tauri::command]
pub fn get_events(state: State<DbState>, offset: u32, limit: u32) -> Result<serde_json::Value, String> {
...
pub fn insert_event(
  ...
  conn.execute(sql, rusqlite::params![timestamp, application, description, (&description_embedding).as_bytes()])
