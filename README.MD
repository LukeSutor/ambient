...
/src-tauri/
└── rust backend for events, LLMs, automation
/frontend/
└── Next.js UI
/models/
└── Downloaded llama.cpp models
/utils/
└── Text formatting, auth hooks, helpers
/docs/
└── Future documentation for task schemas and integration